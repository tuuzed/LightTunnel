...
![LightTunnel LaseVersion](https://img.shields.io/badge/LightTunnel-v0.5.28-blue.svg)
![Thank Idea](https://img.shields.io/badge/Thank-jetbrains.com-green.svg)

## 0x00 发行版下载

[Github下载 LightTunnel-v0.5.28.tar.gz](https://github.com/tuuzed/LightTunnel/releases/download/v0.5.28/LightTunnel-v0.5.28.tar.gz)

[Gitee下载 LightTunnel-v0.5.28.tar.gz](https://gitee.com/tuuzed/LightTunnel/attach_files/383667/download)
