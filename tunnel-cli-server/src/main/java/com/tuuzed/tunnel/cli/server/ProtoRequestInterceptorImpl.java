...
public class ProtoRequestInterceptorImpl implements ProtoRequest.Interceptor {
    @NotNull
    private final String token;
    @Nullable
    private final String portRule;

    public ProtoRequestInterceptorImpl(@NotNull String token, @Nullable String portRule) {
