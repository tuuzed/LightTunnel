...
@Suppress("unused")
class ProtoRequest private constructor(
    val type: Type,
    ...
    companion object Factory {
        ...
        fun fromBytes(bytes: ByteArray): ProtoRequest {
            ...
            try {
                ...
                return ProtoRequest(type, loadAddr, localPort, options)
            } catch (e: Exception) {
        ...
        fun ofTcp(
            ...
            return ProtoRequest(Type.TCP, localAddr, localPort, options0)
        }
        ...
        fun ofHttp(
            ...
            authToken?.also { options0[AUTH_TOKEN] = authToken }
            return ProtoRequest(if (https) Type.HTTPS else Type.HTTP, localAddr, localPort, options0)
        }
