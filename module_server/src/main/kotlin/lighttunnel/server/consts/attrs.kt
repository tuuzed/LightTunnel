...
internal val AK_IS_PLUGIN_HANDLED: AttributeKey<Boolean?> = AttributeKey.newInstance("$PREFIX.isPluginHandled")

internal val AK_IS_INTERCEPTOR_HANDLED: AttributeKey<Boolean?> = AttributeKey.newInstance("$PREFIX.isInterceptorHandled")
