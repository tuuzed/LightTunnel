...
internal class TcpCommand : CliktCommand(name = "tcp") {
    ...
    private val remotePort: Int? by option("-R", "--remote-port", help = "Remote port, default [random]").int()
    ...
    override fun run() {
        ...
        client.connect(
            ...
            tunnelRequest = TunnelRequest.forTcp(
                ...
                if (!this@TcpCommand.authToken.isNullOrEmpty()) {
                    this.authToken = this@TcpCommand.authToken
                }
            },
