...
class TPHttpServerChannelHandler(
    private val registry: TPHttpRegistry,
    ...
    override fun channelInactive(ctx: ChannelHandlerContext) {
        ...
        if (host != null && sessionId != null) {
            ...
            if (descriptor != null) {
                ...
                descriptor.sessionPool.tpChannel.writeAndFlush(TPMassage(TPCommand.REMOTE_DISCONNECT, head))
            }
    ...
    private fun channelReadHttpRequest(ctx: ChannelHandlerContext, msg: HttpRequest) {
        ...
        descriptor.sessionPool.tpChannel.writeAndFlush(TPMassage(TPCommand.TRANSFER, head, data))
    }
