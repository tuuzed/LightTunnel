...
class TPHttpRequestInterceptorImpl : TPHttpRequestInterceptor {
    ...
    override fun handleHttpRequest(
        ...
        tpRequest: TPRequest, httpRequest: HttpRequest
    ): HttpResponse? {
    ...
    private fun handleHttpBasicAuth(tpRequest: TPRequest, httpRequest: HttpRequest): HttpResponse? {
