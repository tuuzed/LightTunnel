...
class TPTcpServerChannelHandler(
    private val registry: TPTcpRegistry
    ...
    override fun channelActive(ctx: ChannelHandlerContext?) {
        if (ctx != null) {
            ...
            if (descriptor != null) {
                ...
                descriptor.sessionPool.tpChannel.writeAndFlush(TPMassage(TPCommand.REMOTE_CONNECTED, head))
            } else {
