...
class HttpClient(
    ...
    companion object {
        internal val REQUEST_CALLBACK = AttributeKey.newInstance<RequestCallback>(
            "lighttunnel.httpclient.REQUEST_CALLBACK"
        )
    }
    ...
    init {
        bootstrap.group(workerGroup).channel(NioSocketChannel::class.java)
            ...
            .handler(object : ChannelInitializer<SocketChannel>() {
                override fun initChannel(ch: SocketChannel) {
                    ...
                    ch.pipeline()
                        ...
                        .addLast("handler", HttpChannelHandler())
                }
            })
    }
